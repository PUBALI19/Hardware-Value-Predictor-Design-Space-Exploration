...
void pipeline_t::writeback(unsigned int lane_number) {
   ...
   if (Execution_Lanes[lane_number].wb.valid) {
      ...
      //////////////////////////////////////////////////////////////////////////////////////////////////////////
      // PROJECT 4: Value Prediction Check
      //
      // Check if a value prediction was made for this instruction at Dispatch.
      // If so, compare the predicted value with the actual computed value.
      // If they differ, signal a value misprediction to the renamer.
      //////////////////////////////////////////////////////////////////////////////////////////////////////////
      
      //bool val_pred_valid;
      //uint64_t val_pred_value;

      //// Query the renamer to see if this instruction has a valid prediction in the AL
      //REN->read_predicted_value(PAY.buf[index].AL_index, val_pred_valid, val_pred_value);

      //if (val_pred_valid) {
      //   // The actual value is stored in the payload buffer (C_value)
      //   if (val_pred_value != PAY.buf[index].C_value.dw) {
